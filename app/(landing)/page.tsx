  ...
  return (
    <main className="max-w-7xl mx-auto">
      ...
      <section className="pt-28 md:pt-36 lg:pt-44" id="home">
         <div className="container flex flex-col px-6 md:px-8 lg:px-40">
          <div className="mx-auto max-w-[864px] justify-center text-center">
            ...
            <p className="mt-5 font-onest text-[#626262] font-medium text-[18px] lg:text-base leading-[22.95px] max-w-[650px] mx-auto">
      ...
      <section className="mt-10 md:mt-20 lg:mt-40">
        <div className="container flex flex-col md:flex-row justify-between items-center px-6 md:px-8 lg:px-20">
          <div className="max-w-[570px]">
            ...
            <p className="font-onest font-medium text-[#626262] text-[18px] lg:text-base mb-3">
              Clientyne is ready to onboard 10,000+ businesses. Streamline
              customer management, analytics, and checkouts with AI-driven
              insights.
            </p>
            <p className="font-onest font-semibold text-[#626262] text-[18px] lg:text-base">
          ...
          <div className="flex gap-5 mt-8 lg:mt-0">
            <Card className="bg-[#333333] w-full lg:h-[194px]">
            ...
            <Card className="bg-[#F9F9F9] w-full lg:h-[194px]">
      ...
      <section className="mt-20 lg:mt-20">
        <div className="container flex flex-col items-center justify-center px-6 md:px-8 lg:px-20">
          <div className="max-w-[766px] mx-auto text-center">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="mt-5 md:mt-6 text-[18px] lg:text-base font-onest text-[#626262] leading-[20.4px] max-w-[590px]">
                {" "}
      ...
      <section className="mt-20 lg:mt-20 flex flex-col lg:flex-row justify-between items-center">
        <div className="container flex flex-col lg:flex-row justify-between items-center px-6 md:px-8 lg:px-20">
          <div className="flex flex-col order-last lg:order-first w-full lg:max-w-[520px]">
            ...
            <p className="text-[#626262] font-onest font-medium text-[18px] lg:text-base mt-3">
            ...
            <p className="text-[#3D3D3D] font-onest font-medium text-[18px] lg:text-base mt-3">
