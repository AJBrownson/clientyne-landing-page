...
export default function FAQs() {
  return (
    <>
      <Accordion type="single" collapsible className="w-full max-w-[650px] flex flex-col gap-y-4">
        <AccordionItem value="item-1" className="border-none">
          <AccordionTrigger className="font-onest font-medium lg:text-base text-[#626262] bg-[#F9F9F9] px-5 rounded-xl hover:no-underline">What is Clientyne?</AccordionTrigger>
        ...
        <AccordionItem value="item-2" className="border-none">
          <AccordionTrigger className="font-onest font-medium lg:text-base text-[#626262] bg-[#F9F9F9] px-5 rounded-xl hover:no-underline">Who is Clientyne for?</AccordionTrigger>
          <AccordionContent className="font-onest text-sm text-[#626262] bg-[#F9F9F9] pl-5 pr-10 rounded-xl">
        ...
        <AccordionItem value="item-3" className="border-none">
          <AccordionTrigger className="font-onest font-medium lg:text-base text-[#626262] bg-[#F9F9F9] px-5 rounded-xl hover:no-underline">When will Clientyne be available?</AccordionTrigger>
          <AccordionContent className="font-onest text-sm text-[#626262] bg-[#F9F9F9] pl-5 pr-10 rounded-xl">
