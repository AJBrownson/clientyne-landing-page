      ...
      <section className="grid grid-cols-1 grid-rows-4 gap-y-6 md:grid-cols-3 md:grid-rows-2 md:gap-x-5 lg:flex lg:flex-row lg:justify-between lg:gap-x-8">
        <Card className="bg-[#F6F7F9] relative flex flex-col w-full md:max-w-[260px] border border-[#E8E8E8]">
          <Image
            src={Pyramid}
            alt=""
            className="hidden lg:block w-10 h-10 absolute left-2 animate-wiggle -top-7"
          />
          <CardHeader>
          ...
          <CardContent className="mt-5 md:mt-10">
            <div className="text-left">
              ...
              <p className="text-[#666] text-[18px] lg:text-sm font-onest font-medium mt-3">
                Clientyne’s personalized shop helps you manage your products and
        ...
        <Card className="bg-[#F6F7F9] relative flex flex-col w-full md:max-w-[260px] border border-[#E8E8E8]">
          ...
          <CardContent className="mt-5 md:mt-10">
            <div className="text-left">
              ...
              <p className="text-[#666] text-[18px] lg:text-sm font-onest font-medium mt-3">
                Easily manage all your customer details in one place and build
        ...
        <Card className="bg-[#F6F7F9] relative flex flex-col w-full md:max-w-[260px] border border-[#E8E8E8]">
          ...
          <CardContent className="mt-5 md:mt-10">
            <div className="text-left">
              ...
              <p className="text-[#666] text-[18px] lg:text-sm font-onest font-medium mt-3">
                Gain insights into your business performance and make
        ...
        <Card className="bg-[#F6F7F9] relative flex flex-col w-full md:max-w-[260px] border border-[#E8E8E8]">
          ...
          <CardContent className="mt-5 md:mt-10">
            <div className="text-left">
              <h1 className="font-redHat text-[#3D3D3D] font-bold text-xl">
                Easy invoicing, organized payments
              </h1>
              <p className="text-[#666] text-[18px] lg:text-sm font-onest font-medium mt-3">
                Send automatic invoices quickly, keeping your payments organized
                and hassle-free.
              </p>
            </div>
          </CardContent>
