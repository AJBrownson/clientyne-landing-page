  ...
  return (
    <>
      <header className="fixed w-full flex justify-center py-10 z-50">
        <nav className="flex justify-between items-center bg-[#0E0E0D] text-[#C6C6C6] h-16 px-2 w-full max-w-[570px] rounded-full">
          ...
          <Button className="bg-[#fff] text-[#3D3D3D] py-6 px-4 rounded-full font-onest font-semibold lg:text-base hover:bg-[#fff]">
            Book a Demo
          </Button>
        </nav>
      </header>
